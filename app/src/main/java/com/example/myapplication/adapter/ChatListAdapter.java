...
import com.example.myapplication.model.user.Chatlist;
import com.example.myapplication.view.activities.chats.ChatsActivity;
...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.Holder>  {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        if (chatlist.getUrlProfile().equals("")){
            holder.profile.setImageResource(R.drawable.profile_image);  // set  default image when profile user is null
        } else {
